...
# ketamine, legal highs, LSD, methadone, mushrooms, nicotine and volatile substance abuse and o#######################################
### DRUG CONSUMPTION CLASSIFICATION ###
#######################################
...
DC$Age <- factor(DC$Age, 
                     levels = c(-0.95197, -0.07854, 0.49788, 1.09449, 1.82213,
                                2.59171),
...
# Scegliamo su quali predittori spiegare l'utilizzo di Cannabis e Cocaina:
DC = DC[, !(names(DC) %in% c("Country", "Ethnicity", "Impulsive", "SS", "Amphet", "Amyl", "Benzos", "Caff", "Choc", "Crack", "Ecstasy", "Heroin", "Ketamine", "Legalh", "LSD", "Meth", "Mushrooms", "Semer", "VSA"))]
View(DC)

pairs(savings, pch=16)
pairs(savings[ , c('', 'pop15', 'pop75', 'dpi', 'ddpi')], pch = 16)

ne fictitious drug (Semeron) which was introduced to identify over-claimers. For each drug they have to select one of the answers: never used the drug, used it over a decade ago, or in the last decade, year, month, week, or day. Database contains 18 classification problems.
# Each of independent label variables contains seven classes: "Never Used", "Used over a Decade Ago", "Used in Last Decade", "Used in Last Year", "Used in Last Month", "Used in Last Week", and "Used in Last Day".
